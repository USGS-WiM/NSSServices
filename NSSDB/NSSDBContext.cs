...
#warning Add connectionstring for migrations
            var connectionstring = "User ID=testadmin;Password=euOjmZXwywrsAt5wbXMa;Host=test.c69uuui2tzs0.us-east-1.rds.amazonaws.com;Port=5432;Database=StatsDB;Pooling=true;";
