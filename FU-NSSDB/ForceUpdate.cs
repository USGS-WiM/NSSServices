...
namespace FU_NSSDB
{
    public class ForceUpdate
    {
        ...
        private string NSSDBConnectionstring = string.Format("Server=nsstest.ck2zppz9pgsw.us-east-1.rds.amazonaws.com; database={0}; UID=nssadmin; password=Lj1ulzxcZvmXPNFmI03u", "nss");
        ...
        private void init() {
            string connectionString = "metadata=res://*/NSSEntityModel.csdl|res://*/NSSEntityModel.ssdl|res://*/NSSEntityModel.msl;provider=MySql.Data.MySqlClient;provider connection string=';server=nsstest.ck2zppz9pgsw.us-east-1.rds.amazonaws.com;user id=nssadmin;PASSWORD={0};database=nss';";
            string password = "Lj1ulzxcZvmXPNFmI03u";
