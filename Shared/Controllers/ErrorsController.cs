...
{
    public abstract class ErrorsControllerBase : WIM.Services.Controllers.ControllerBase
    {
        protected ISharedAgent shared_agent;
        public ErrorsControllerBase(ISharedAgent shared_sa) : base()
        {
        ...
        public virtual async Task<IActionResult> Post([FromBody]ErrorType entity)
        {
            try
            {
        ...
        public virtual async Task<IActionResult> Batch([FromBody]List<ErrorType> entities)
        {
            try
            {
        ...
        public virtual async Task<IActionResult> Put(int id, [FromBody]ErrorType entity)
        {
            try
            {
