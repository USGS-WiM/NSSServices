...
namespace NSSService.Utilities.ServiceAgent
{
    public class RegressionServiceAgent:ServiceAgent
    {
        ...
        public List<NSSService.Resources.Parameter> GetParameterList(string stateID, string modelType, string region = null)
        {
            try
            {
                ...
                return JsonConvert.DeserializeObject<List<NSSService.Resources.Parameter>>(parameters);
            }
            catch (Exception)
            {
                return null;
